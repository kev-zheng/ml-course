function [J grad] = nnCostFunction(nn_params, ... % Column vector of params
...
% Expand y from digit to index logical vector
y_mat = 1:num_labels == y; % 5000 x 10
...
% Remove bias unit for regularization
...
for t = 1:m
    ...
    a2 = [1, sigmoid(z2)]; % Hidden layer, add bias unit
    z3 = a2 * Theta2';
    a3 = sigmoid(z3);
    
    d3 = a3 - y_mat(t, :); % Output layer error

    d2 = d3 * Theta2(:, 2:end) .* sigmoidGradient(z2); % Hidden layer error
